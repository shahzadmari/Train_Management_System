...
public class Viewrecord extends JFrame implements ActionListener{
	...
	public Viewrecord() {
	    ...
	    String columsn[]= {"cutomer_name ","phone","cnic","starting","Ending","category","train","tickets","price","date","code"};
	    ...
	    tabel.setFont(new Font(Font.DIALOG,Font.ROMAN_BASELINE,15));
