...
public class CarGame extends Thread implements MouseListener {
    ...
    JLabel bg1 = new JLabel(new ImageIcon(getClass().getClassLoader().getResource("images/track.jpg")));
    ...
    JLabel car4 = new JLabel(new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif")));
    JLabel car5 = new JLabel(new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif")));
    JLabel car6 = new JLabel(new ImageIcon(getClass().getClassLoader().getResource("images/car6.gif")));
    JLabel car7 = new JLabel(new ImageIcon(getClass().getClassLoader().getResource("images/car7.gif")));
    JLabel car8 = new JLabel(new ImageIcon(getClass().getClassLoader().getResource("images/car8.gif")));
    JLabel getready = new JLabel("");
    JButton s1 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("images/car1.gif")));
    JButton s2 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("images/car2.gif")));
    JButton s3 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("images/car3.gif")));
    JButton s4 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif")));
    JButton s5 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif")));
    ...
    public class crash extends Thread {
        public void run() {
            while (stopper) {
                ...
                if (r1.intersects(c1) || r1.intersects(c2) || r1.intersects(c3) || r1.intersects(c4)
                        || r1.intersects(c5) || r1.intersects(c6) || r1.intersects(c7) || r1.intersects(c8)) {
                    stopper = false;
                    gameover();
        ...
        public void run() {
            while (stopper) {
                ...
                if (Score < 2000 || Score == 6000) {
                    ...
                    background1.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/bg2.jpg")));
                    background2.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/bg2.jpg")));
                    background3.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/bg2.jpg")));
    ...
    CarGame() {
        ...
        car2.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car2.gif")).getIconWidth(),
                (new ImageIcon(getClass().getClassLoader().getResource("images/car2.gif"))).getIconHeight());
        car3.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car3.gif")).getIconWidth(),
                (new ImageIcon(getClass().getClassLoader().getResource("images/car3.gif"))).getIconHeight());
        car4.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif")).getIconWidth(),
                (new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif"))).getIconHeight());
        car5.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif")).getIconWidth(),
                (new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif"))).getIconHeight());
        car6.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car6.gif")).getIconWidth(),
                (new ImageIcon(getClass().getClassLoader().getResource("images/car6.gif"))).getIconHeight());
        car7.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car7.gif")).getIconWidth(),
                (new ImageIcon(getClass().getClassLoader().getResource("images/car7.gif"))).getIconHeight());
        car8.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car8.gif")).getIconWidth(),
                (new ImageIcon(getClass().getClassLoader().getResource("images/car8.gif"))).getIconHeight());
        s1.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car1.gif")).getIconWidth(), (new ImageIcon(getClass().getClassLoader().getResource("images/car1.gif"))).getIconHeight());
        s2.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car2.gif")).getIconWidth(), (new ImageIcon(getClass().getClassLoader().getResource("images/car2.gif"))).getIconHeight());
        s3.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car3.gif")).getIconWidth(), (new ImageIcon(getClass().getClassLoader().getResource("images/car3.gif"))).getIconHeight());
        s4.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif")).getIconWidth(), (new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif"))).getIconHeight());
        s5.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif")).getIconWidth(), (new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif"))).getIconHeight());
...
//    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == help)
            JOptionPane.showMessageDialog(f,
                    "1. Select a car by clicking on \"Select Car\" button.\n2. Click \"Play\" to start the game.\n3. Move your cursor left or right for driving directions.\n4. Or let the cursor be on Play button & right click to turn\n     right & left click to turn left.\n					5. If it's too slow or too fast click on \"modify sensor\" button.\n6. Move cursor top-left/botton-left for Horns.",
                    "Help Topics", JOptionPane.INFORMATION_MESSAGE);
        if (e.getSource() == about)
            JOptionPane.showMessageDialog(f,
                    "My name is Zameer Ali, I'm the coder of this Simple Game.\nMy roll-no is 20SW046\nI belong to Mehran UET, doing BE Software Engineering ",
                    "About Author", JOptionPane.INFORMATION_MESSAGE);
        if (e.getSource() == exit) {
            new Start();
            f.setVisible(false);}
        if (e.getSource() == changesensor) {
            String xy = JOptionPane.showInputDialog(
                    "If you think mouse-motion-sensor is too high or low\nGive your speed here, 22=Slowest, 8=Fastest.\n(By default everytime you open this game it'll become 16)",
                    "any number between 8 & 22");
            int tmp = 0;
            if (xy != null)
            ...
            if (tmp >= 8 && tmp <= 22)
                ...
                JOptionPane.showMessageDialog(f,
                        "As I told you 8 is for Fastest & 22 is for Slowest, Give values between 8 & 22 only :')");
        }
        if (e.getSource() == changename) {
            try {
                String nm = JOptionPane.showInputDialog(
                        "What is your name? I guess," + InetAddress.getLocalHost().getHostName() + "!");
                NAME.setText(nm);
            }
    ...
    public void selecthero(int ijk) {
        ...
        case 2:
            ...
            break;
        case 3:
            hero.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/car3.gif")));
            hero.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car3.gif")).getIconWidth(),
                    (new ImageIcon(getClass().getClassLoader().getResource("images/car3.gif"))).getIconHeight());
            SELECTED = true;
            break;
        case 4:
            hero.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif")));
            hero.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif")).getIconWidth(),
                    (new ImageIcon(getClass().getClassLoader().getResource("images/car4.gif"))).getIconHeight());
            SELECTED = true;
            break;
        case 5:
            hero.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif")));
            hero.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif")).getIconWidth(),
                    (new ImageIcon(getClass().getClassLoader().getResource("images/car5.gif"))).getIconHeight());
            SELECTED = true;
            break;
        case 6:
            hero.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/car6.gif")));
            hero.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car6.gif")).getIconWidth(),
                    (new ImageIcon(getClass().getClassLoader().getResource("images/car6.gif"))).getIconHeight());
            SELECTED = true;
            break;
        case 7:
            hero.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/car7.gif")));
            hero.setSize(new ImageIcon(getClass().getClassLoader().getResource("images/car7.gif")).getIconWidth(),
                    (new ImageIcon(getClass().getClassLoader().getResource("images/car7.gif"))).getIconHeight());
            SELECTED = true;
            break;
        case 8:
