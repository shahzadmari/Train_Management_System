...
public class Addrecord extends MouseAdapter implements ActionListener{
	...
	public Addrecord() {
	 ...
	 leftmargin = new JLabel();
	   ...
	   namefield.addMouseListener(this);
	    ...
	    nofield.setText("Enter Number");
	    nofield.addMouseListener(this);
...
//		});
		...
		cnicfield.setText("Enter Email");
		cnicfield.addMouseListener(this);
	...
	public void mousePressed(MouseEvent e) {
		...
		if(e.getSource() == nofield)
			nofield.setText("");
		
		if(e.getSource() == cnicfield)
			cnicfield.setText("");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == confirm)
			...
			if(!(namefield.getText().equals("")) && !(cnicfield.getText().equals("")) && !(nofield.getText().equals("")) && no!=0 && temp!=0) {  
				...
				if(cnicfield.getText().contains("@gmail.com") && nofield.getText().length() > 11) {
				...
				save.setEnabled(true);
					...
					JOptionPane.showMessageDialog(null, "wrong email provided");
				}
		...
		if(e.getSource() == save) {
            ...
            String command = "insert into customer_record values ('"+cname+"',"+cphone+",'"+ccnic+"','"+cstart+"','"+cend+"','"+ccategory+"','"+ctrain+"',"+ctickets+","+cprice+",'"+cdate+"',"+code+")";      
	        ...
	        String to = cnicfield.getText();
	        
	        // Sender's email ID needs to be mentioned
	        String from = "trainsystemapsz@gmail.com";
	        ...
	        Session session = Session.getInstance(properties, new Authenticator() {
	            ...
	            protected PasswordAuthentication getPasswordAuthentication() {
	                ...
	                return new PasswordAuthentication("trainsystemapsz@gmail.com", "463767122");
	        ...
	        try {
	            ...
	            message.setSubject("Thanks for using our System!");
	            int n=code;
	            // Now set the actual message
	            message.setText("Dear Customer the code for your ticket is "+n+" ."+
	            "\n1 => open user portal in our system\n"
	            + "2 =>Enter given code to generate your ticket \n\n\n"
	            + "\talways be connected with us Thanks."
	           );

	            System.out.println("sending...");
	            // Send message
	            Transport.send(message);
	        	JOptionPane.showMessageDialog(null, "A code has been sent to "+cnicfield.getText()+" check it Asap");
